...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規機能 ' do
    ...
    context '新規登録がうまくいくとき'do
      ...
      it "nickname,email,password,password_confirmation,first_name,last_name,first_name_kana,last_name_kanaが存在すれば登録できる" do
